#!/usr/bin/env bash
# ============================================================
# MULTIMODAL WEIGHTED SUM FUSION (ECG + TEXT)
# No parameter sweep
#
# Projection:
#   h_ECG  = W_e * z_ECG   -> 128
...
#
# where:
#   a = sigmoid(alpha) (learnable scalar)
#
# Classifier:
#   hidden_dim=128
#   dropout=0.2
...
OUTPUT_DIR="../../music/best_results/weightedsum_embeddings_LLaMA8B_BioBERT"
...
GPU=5
SESSION_NAME="multimodal_weighted_sum"
...
do
  ...
  python train_multimodal_weighted_sum.py \
    --val_fold \${FOLD} \
...
echo "=========================================="
echo "Multimodal weighted sum fusion launched."
