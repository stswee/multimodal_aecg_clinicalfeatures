...
def setup_logging(out_dir: Path):
    ...
    log_path = log_dir / f"train_multimodal_concat_{ts}.log"
...
class ConcatMultiHead(nn.Module):
    """
    Direct concatenation multimodal classifier.
...
def main():
    ...
    if best_p_scd is not None and best_p_pfd is not None:
        ...
        logging.info("Saved best-epoch validation predictions to val_predictions.npz")
    else:
        logging.warning("No best predictions were stored; val_predictions.npz not written.")
