...
#
# Usage:
#   bash run_segment_HRV_tmux.sh
#
# Then attach with:
#   tmux attach -t segment_hrv
# ================================================================

SESSION_NAME="segment_hrv"

# ---------------------------
# COMMAND
# ---------------------------
CMD="python segment_all_patients_by_start_indices_HRV.py \
