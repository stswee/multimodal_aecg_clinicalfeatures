...
(modeled exactly after train_mil_ecg_tcn.py).
...
5. Temporal mean pooling produces a patient-level embedding
...
# =========================================================
# Label mapping (binary, same as ECG script)
# =========================================================
...
# =========================================================
# Dataset (CSV-based, MIL semantics)
# =========================================================
class HRVMILDataset(Dataset):
    """One item = one patient (bag of HRV feature windows)"""
...
class WindowFeatureEncoder(nn.Module):
    """MLP encoder for HRV feature vectors"""
