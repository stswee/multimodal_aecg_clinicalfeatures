...
# ---------------- USER CONFIG ----------------
SESSION_NAME="tcn_attn_mil_multiclass_SCDPFD_fold4"
GPU_ID=7
...
OUTPUT_DIR="../../../../local3/sswee/music_download/physionet.org/files/music-sudden-cardiac-death/1.0.1/tcn_attn_mil_outputs_multiclass_SCDPFD"
...
PYTHON_SCRIPT="train_tcn_mil_hrv_multiclass_SCDPFD.py"
