#!/usr/bin/env python3
"""Post hoc figures and decision curves for the literature-reduced sensitivity.
...
TASKS = ("scd", "pfd")
FEATURE_SETS = ("literature_reduced",)
ARMS = ("penalized_logistic", "gradient_boosting", "selected_tabular")

DISPLAY_NAMES = {
    ("literature_reduced", "penalized_logistic"): "Reduced clinical logistic",
    ("literature_reduced", "gradient_boosting"): "Reduced clinical gradient boosting",
    ("literature_reduced", "selected_tabular"): "Selected reduced clinical model",
}

COLORS = {
    ("literature_reduced", "penalized_logistic"): "#2166ac",
    ("literature_reduced", "gradient_boosting"): "#b2182b",
    ("literature_reduced", "selected_tabular"): "#1b9e77",
}
...
PRINCIPAL_MODELS = (
    ("literature_reduced", "selected_tabular"),
    ("literature_reduced", "penalized_logistic"),
    ("literature_reduced", "gradient_boosting"),
)
...
def plot_principal_decision_curves(
    ...
    for axis, task in zip(axes, ("SCD", "PFD")):
        ...
        axis.grid(alpha=0.2)
        axis.legend(fontsize=8)
    figure.suptitle("Exploratory decision curves: literature-reduced clinical models")
    figure.tight_layout()
    save_figure(figure, destination)
