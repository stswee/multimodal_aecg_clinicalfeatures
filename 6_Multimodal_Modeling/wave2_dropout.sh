...
# ---- Projected Concat ----
run_projected_method projected_concat train_multimodal_projectconcat.py 128 128 2
run_projected_method projected_concat train_multimodal_projectconcat.py 256 256 1

# ---- Scalar Gating ----
run_projected_method scalar_gating train_multimodal_scalar_gating.py 128 128 1
run_projected_method scalar_gating train_multimodal_scalar_gating.py 128 256 2

# ---- Vector Gating ----
run_projected_method vector_gating train_multimodal_vector_gating.py 128 128 2
run_projected_method vector_gating train_multimodal_vector_gating.py 256 256 2

# ---- Weighted Sum ----
run_projected_method weighted_sum train_multimodal_weighted_sum.py 128 128 1
run_projected_method weighted_sum train_multimodal_weighted_sum.py 128 256 2
