...
SESSION_NAME="preprocess_ecgs_HRV"
...
OUTPUT_PATH="../../../../local3/sswee/music_download/physionet.org/files/music-sudden-cardiac-death/1.0.1/preprocessed_HRV"              # e.g., /local3/sswee/MUSIC/preprocessed
SKIP_SECONDS=30                             # e.g., 30 for MUSIC, 0 for SHDB-AF
CSV_NAME="preprocessing_metadata_HRV.csv"       # choose output metadata CSV name
LIMIT=""                                    # e.g., 50 (or leave blank for all records)

# Python script
SCRIPT="preprocess_all_ecgs_HRV.py"
